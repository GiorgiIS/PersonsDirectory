        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UpdatedAt = table.Column<DateTime>(nullable: true),
                    DeletedAt = table.Column<DateTime>(nullable: true),
                    ConnectedPersonId = table.Column<int>(nullable: false),
                    ConnectionType = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ConnectedPersonModel", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ConnectedPersonModel_Persons_ConnectedPersonId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ConnectedPersonModel_ConnectedPersonId",
                table: "ConnectedPersonModel",
